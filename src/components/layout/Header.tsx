  ...
  return (
    <header className="flex items-center gap-4 border-b border-hair-2 bg-bg-panel px-4 py-3">
      ...
      <div className="flex items-baseline gap-2">
        <span className="text-12 font-semibold tracking-wide-3 text-ink-0">
          HAWKEYE
        </span>
        <span className="text-10 uppercase tracking-wide-3 text-ink-3">
          Sterling Screening
        </span>
      </div>
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <div className="hidden items-center gap-2 rounded-lg border border-hair-2 bg-bg-1 px-3 py-1.5 text-11 text-ink-3 md:flex">
          ...
          <span className="rounded border border-hair px-1 font-mono text-10 text-ink-3">
            /
          </span>
        </div>
